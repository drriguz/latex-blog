...
我们安装#link("https://store.docker.com/community/images/sonatype/nexus3")[Nexus]来作为我们的Docker镜像仓库。
...
安装完成后，可以访问192.168.56.101:8081，登录进去后，添加一个Docker
Hosted源，比如http:/\/192.168.56.101:8081/repository/cloud-images/
...
这样就可以通过http:/\/192.168.56.101:8081/repository/files/gradle-4.0-bin.zip
来访问我们这个文件了。

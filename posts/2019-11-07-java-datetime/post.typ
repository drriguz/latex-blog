...
- 通过计算当前时间到Jan 01 1970(Unix
  Epoch)这一天（准确的说是00：00）经过的秒数来表示，例如 `1573090869`。
- 比较直接的方法就是直接以时分秒的形式表示当地时间，同时将当地的时区加进去，例如
...
#figure(
  align(center)[#table(
    ...
    table.header([Class], [Since], [Description],),
    table.hline(),
...
simpler applications. This class may be used when modeling date-time
concepts in more detail, or when communicating to a database or in a
network protocol.
]
...
- #link("https://stackoverflow.com/questions/30234594/whats-the-difference-between-java-8-zoneddatetime-and-offsetdatetime")[What's the difference between java 8 ZonedDateTime and OffsetDateTime?]
- #link("https://docs.oracle.com/javase/8/docs/api/java/time/OffsetDateTime.html")[OffsetDateTime]
- #link("https://docs.oracle.com/javase/8/docs/api/java/time/ZonedDateTime.html")[ZonedDateTime]

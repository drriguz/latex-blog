...
== 核心概念
<核心概念>
// Remote image removed: https://netty.io/3.8/guide/images/architecture.png
// #figure(image("https://netty.io/3.8/guide/images/architecture.png", alt: "Netty architecture"),
//   caption: [
//     Netty architecture
//   ]
// )
...
<eventloop与server-channelchannel>
其运行原理如图：

// Remote image removed: https://dpzbhybb2pdcj.cloudfront.net/maurer/Figures/03fig04_alt.jpg
// #figure(image("https://dpzbhybb2pdcj.cloudfront.net/maurer/Figures/03fig04_alt.jpg", alt: "EventLoopGroup and Channels"),
//   caption: [
//     EventLoopGroup and Channels
//   ]
// )
...
// Remote image removed: https://dpzbhybb2pdcj.cloudfront.net/maurer/Figures/03fig03_alt.jpg
// #figure(image("https://dpzbhybb2pdcj.cloudfront.net/maurer/Figures/03fig03_alt.jpg", alt: "Channel Pipeline"),
//   caption: [
//     Channel Pipeline
//   ]
// )
...
- #link("https://netty.io/wiki/user-guide-for-4.x.html")[Netty User guide for 4.x]
- #link("https://livebook.manning.com/book/netty-in-action")[Netty in Action]

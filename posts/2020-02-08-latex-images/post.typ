...
== 使用`subfig`包
<使用subfig包>
#link("https://ctan.org/pkg/subfig")[subfig]是一个可以支持嵌套Figure或者表格的包，这个包是`subfigure`包的替代品，后者已经被弃用了。
...
== 使用`subfloat`包
<使用subfloat包>
#link("www.ctan.org/pkg/subfloat")[subfloat]是另一个包，用法如下：
...
== 使用`subcaption`包
<使用subcaption包>
另有使用#link("http://www.ctan.org/pkg/caption")[caption]和#link("http://www.ctan.org/pkg/subcaption")[subcaption]包结合的方式。`subcaption`包更加新一些，可能更适合选用。
...
- #link("https://tex.stackexchange.com/questions/16207/image-from-includegraphics-showing-up-in-wrong-location")[Image from \\includegraphics showing up in wrong location?]
- #link("https://tex.stackexchange.com/questions/122314/figures-what-is-the-difference-between-using-subfig-or-subfigure")[Figures: What is the difference between using subfig or subfigure]

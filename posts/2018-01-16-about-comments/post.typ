...
#quote(block: true)[
Good programming is self-explanatory. Bad Programming requires
explanation
]
...
#quote(block: true)[
self-explanatory code only tell how it is working. It rarely tells how
it should work.
]
...
姑且不说一个简单的Bean用这么多Lombok注解的问题\~
然后我需要做的是，模拟这个系统的出错返回，因为我们的开发环境无法连真实的三方系统测试。那么问题来了，三方系统出错的时候，应该返回什么呢？

首先问问写这个代码的人（也就是直接对接这个系统的人）吧。他给了我一个文档，文档里面是这么描述的：
#box(image("images/about_comments_1.png", alt: "the document"))

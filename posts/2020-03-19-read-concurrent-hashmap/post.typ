...
#show: blog-post.with(
  ...
  date: "2020-03-19",
  tags: ("刨根问底", "并发编程", "JDK1.8", "Concurrent"),
  lang: "zh",
)
...
而在1.8中直接使用CAS+
synchronized来实现。其在内存中的结构与HashMap几乎相同了。
...
- #link("https://www.javatpoint.com/difference-between-hashmap-and-hashtable")[Difference between HashMap and Hashtable]

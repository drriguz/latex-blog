...
#show: blog-post.with(
  ...
  date: "2018-05-09",
  tags: ("JMH", "闲话编程", "Benchmark", "Perfomance", "Base64", "框架"),
  lang: "zh",
)

JMH是一个测试Java程序性能的工具，比如我们现在要测试一下JDK8自带的Base64和#link("http://www.java2s.com/Code/Java/Development-Class/AfastandmemoryefficientclasstoencodeanddecodetoandfromBASE64infullaccordancewithRFC2045.htm")[另一个实现]的性能。

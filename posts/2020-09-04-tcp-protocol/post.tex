...
\subsection{OSI模型}\label{osiux6a21ux578b}
...
\tightlist
\item
  物理层(Physical Layer)在局域网传输数据帧(Data Frame)，负责管理电脑通信设备和网络媒体之间的互通
\item
...
\section{运作方式}\label{ux8fd0ux4f5cux65b9ux5f0f}

TCP协议运行分为三个阶段：创建连接、数据传送和连接终止。首先来看TCP的数据包的结构：

\subsection{TCP包结构}\label{tcpux5305ux7ed3ux6784}

TCP将数据封装在IP报文中进行传输。

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textless{}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}\NormalTok{IP报文}\OperatorTok{{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}\textgreater{}}
\OperatorTok{|{-}{-}{-}{-}{-}{-}{-}}\NormalTok{IP头部}\OperatorTok{{-}{-}{-}{-}{-}{-}{-}{-}|{-}{-}{-}{-}{-}{-}{-}}\NormalTok{TCP头部}\OperatorTok{{-}{-}{-}{-}{-}{-}{-}{-}|{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}\NormalTok{TCP数据}\OperatorTok{{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}|}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={TCP package structure}]{images/Tcp-package.png}}
\caption{TCP package structure}
\end{figure}
...
\item
  目的端口 接收连接端口
\item
  序列号：如果含有\texttt{SYN}标记，则此为最初的序列号；第一个资料的序列号将+1；如果没有则为第一个资料比特的序列号
\item
...
\subsection{连接创建与关闭}\label{ux8fdeux63a5ux521bux5efaux4e0eux5173ux95ed}
...
\tightlist
\item
  客户端向服务端发送\texttt{SYN}来创建一个主动打开，客服端设定这段连接的序号为随机数 \(ISN(c)\)
\item
  服务端收到\texttt{SYN}后回复\texttt{SYN/ACK}，确认号为\(ISN(c)+1\)，而这个回复包含一个随机序号\(ISN(s)\)
\item
  最后，客户端再次发送一个\texttt{ACK},此时包的序号为\(ISN(c) + 1\)，服务端回复的确认码为\(ISN(s) + 1\)。这样就完成了三次握手，进入了连接创建状态
\end{enumerate}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Tcp connection flow}]{images/Tcp-connection.png}}
\caption{Tcp connection flow}
\end{figure}
...
\tightlist
\item
  主动关闭者发送一个\texttt{FIN}指明希望看到自己当前的序列号(K)，并包含了对方最近一次的数据序列号(L)
\item
  被动关闭者发送\texttt{ACK}表明已经成功接收到\texttt{FIN}，并通知上层的应用程序连接端已经提出了关闭操作
\item
  接着被动关闭者将变成主动关闭者，并发送\texttt{FIN}
\item
  收到\texttt{ACK}，完成连接的关闭
\end{enumerate}

因为TCP是双工通信，实际上支持一种半关闭的操作，也就是说一方数据发送完成后关闭传输但任然保留接收数据的能力。这种情况下只有一方发送了\texttt{FIN}，但实际很少有程序使用这种特性。

\section{其他需要了解的性质}\label{ux5176ux4ed6ux9700ux8981ux4e86ux89e3ux7684ux6027ux8d28}
